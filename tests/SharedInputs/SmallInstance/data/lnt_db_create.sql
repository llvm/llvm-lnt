...
INSERT INTO "NT_Order" VALUES(3,NULL,NULL,'154331');
INSERT INTO "NT_Order" VALUES(4,3,NULL,'152289');
UPDATE "NT_Order" SET "PreviousOrder"=4 WHERE "ID"=3; --INTO "NT_Order" VALUES(3,NULL,4,'154331');
...
INSERT INTO "NT_Test" VALUES(2,'SingleSource/UnitTests/2006-12-04-DynAllocAndRestore');
CREATE TABLE "NT_Run" (
	"ID" INTEGER NOT NULL, 
	"MachineID" INTEGER, 
	"OrderID" INTEGER, 
...
INSERT INTO "compile_Order" VALUES(2,NULL,NULL,'154331');
INSERT INTO "compile_Order" VALUES(3,2,NULL,'154335');
INSERT INTO "compile_Order" VALUES(4,3,NULL,'154339');
UPDATE "compile_Order" SET "PreviousOrder"=3 WHERE "ID"=2;
UPDATE "compile_Order" SET "PreviousOrder"=3 WHERE "ID"=3;
