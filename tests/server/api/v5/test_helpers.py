...
from lnt.server.api.v5.helpers import escape_like, parse_datetime
...
class TestParseDatetime(unittest.TestCase):
    ...
    def test_naive_datetime_unchanged(self):
        """A naive ISO string (no timezone) should be returned as-is."""
        result = parse_datetime('2024-01-15T10:00:00')
        self.assertEqual(result, datetime.datetime(2024, 1, 15, 10, 0, 0))

    def test_utc_timezone(self):
        """A datetime with explicit +00:00 offset should remain the same
        value after stripping tzinfo (already UTC)."""
    ...
    def test_positive_offset_converted_to_utc(self):
        ...
        self.assertEqual(result, datetime.datetime(2024, 1, 15, 5, 0, 0))
    ...
    def test_negative_offset_converted_to_utc(self):
        ...
        result = parse_datetime('2024-01-15T10:00:00-05:00')
        self.assertEqual(result, datetime.datetime(2024, 1, 15, 15, 0, 0))

    def test_result_is_naive(self):
        """The returned datetime must always be naive (no tzinfo)."""
        result = parse_datetime('2024-01-15T10:00:00+05:00')
